...
func (x *NewOrder) GetUserId() int32 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *NewOrder) GetGoodsId() int32 {
	if x != nil {
		return x.GoodsId
	}
	return 0
...
var file_order_proto_rawDesc = []byte{
	...
	0x6d, 0x70, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x3e, 0x0a, 0x08, 0x4e, 0x65,
	0x77, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x17, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69,
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12,
	0x19, 0x0a, 0x08, 0x67, 0x6f, 0x6f, 0x64, 0x73, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x05, 0x52, 0x07, 0x67, 0x6f, 0x6f, 0x64, 0x73, 0x49, 0x64, 0x22, 0x1a, 0x0a, 0x08, 0x55, 0x73,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0xfa,
	...
	0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x31, 0x0a, 0x0c, 0x4e, 0x65, 0x77, 0x4f,
	0x72, 0x64, 0x65, 0x72, 0x46, 0x75, 0x6e, 0x63, 0x12, 0x09, 0x2e, 0x4e, 0x65, 0x77, 0x4f, 0x72,
...
var file_order_proto_depIdxs = []int32{
	...
	0,  // 12: Order.NewOrderFunc:input_type -> NewOrder
	...
	12, // 21: Order.NewOrderFunc:output_type -> google.protobuf.Empty
...
type OrderClient interface {
	...
	NewOrderFunc(ctx context.Context, in *NewOrder, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *orderClient) NewOrderFunc(ctx context.Context, in *NewOrder, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/Order/NewOrderFunc", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServer interface {
	...
	NewOrderFunc(context.Context, *NewOrder) (*emptypb.Empty, error)
}
...
func (*UnimplementedOrderServer) NewOrderFunc(context.Context, *NewOrder) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method NewOrderFunc not implemented")
}
...
func _Order_NewOrderFunc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NewOrder)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServer).NewOrderFunc(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Order/NewOrderFunc",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServer).NewOrderFunc(ctx, req.(*NewOrder))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Order_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "NewOrderFunc",
			Handler:    _Order_NewOrderFunc_Handler,
		},
	},
